...
class Document(Base):
    ...
    source: Mapped[str] = mapped_column(String(32), nullable=True, server_default="public")
    review_state: Mapped[str] = mapped_column(String(32), nullable=True, server_default="pending")
